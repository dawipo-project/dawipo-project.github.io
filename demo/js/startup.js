...
(function ($) {
  $(document).ready(function(){
    ...
    btn.on("click", function (e) {
      e.preventDefault();
      $("html, body").animate({ scrollTop: 0 }, (duration = 2500));
    });

    $(document).ready(function(){
        // Back to top
        var btn = $("#botonRegresar");
        btn.on("click", function (e) {
        e.preventDefault();
        $("html, body").animate({ scrollTop: 0 }, (duration = 2500));
        });
        ...
        return this.each(function (i) {
          ...
          if (window.innerWidth >= responsiveThreshold) {
            ...
            if ($this.hasClass("title-transition")) {
              ...
              var getThirdOfDuration = parseDuration(duration, "150%", 0.33);
              ...
              $this
                ...
                .on("click.read-more", function () {
                  var scrollDuration =
                    getOneAndHalfWindowHeight() + window.innerHeight;
                  var offsetAndDuration = dynamicOffsetAndDuration(
                    300,
                    scrollDuration,
                    originalOffset
                  );
                  $("html, body").animate(
                    { scrollTop: offsetAndDuration[0] },
                    offsetAndDuration[1]
                  );
                });
              ...
              // build tween
              var tweenZoomOut = TweenMax.to(laptop, 1, {
                scale: 0.5,
                ease: Power2.easeInOut,
              });
              var tweenFadeHeader = TweenMax.to(header, 1, {
                opacity: 0,
                ease: Power2.easeInOut,
              });
              var tweenFadeNavbar = TweenMax.to(navbar, 1, {
                opacity: 0,
                ease: Power2.easeInOut,
              });
              ...
              var scene = new ScrollMagic.Scene({
                duration: getOneAndHalfWindowHeight,
              })
              ...
              currentTransitions[dataId] = {
                ...
                sceneTweenPairs: [
                  { scene: scene, tween: tweenZoomOut },
                  { scene: scene2, tween: tweenFadeHeader },
                  { scene: scene3, tween: tweenFadeNavbar },
                ],
              };
              ...
              columns.each(function () {
                ...
                phones.each(function (i) {
                  var mult = len - i;
                  var randDelay =
                    (Math.round((Math.random() / 2 + 0.5) * 10) / 10) * mult;

                  tweenPhoneTimeline.to(
                    this,
                    1,
                    { className: "+=active", ease: Power2.easeInOut },
                    randDelay
                  );
                });
              });
              ...
              currentTransitions[dataId] = {
                ...
                sceneTweenPairs: [
                  { scene: scene, tween: tweenPhoneTimeline, isTimeline: true },
                ],
              };
              ...
              if (isStart) {
                tween = TweenMax.to(fixedWrapper, 1, {
                  scale: 0.4,
                  rotationX: 110,
                  y: "-40%",
                });
              ...
              currentTransitions[dataId] = {
                ...
                sceneTweenPairs: [
                  { scene: scene, tween: tween, isTimeline: isTimeline },
                ],
              };
              ...
              $this
                ...
                .on("click.read-more", function (e) {
                  var index =
                    $(this)
                      .closest(".circle-reveal-wrapper")
                      .index(".circle-reveal-wrapper") + 1;
                  $("html, body").animate(
                    { scrollTop: originalOffset + window.innerHeight * index },
                    800
                  );
                });
              ...
              $this.find(".circle-reveal-wrapper").each(function (i) {
                ...
                // build tween
                tweenCircleTimeline.to(circle, 1, {
                  scale: 0,
                  ease: Power2.easeInOut,
                });
                tweenFadeTimeline
                  .to(header, 0.5, {
                    ...
                    onComplete: function () {
                      if (
                        wrapper
                          .next(".circle-reveal-wrapper")
                          .find(".circle-background")
                          .hasClass("white")
                      ) {
                    ...
                    onReverseComplete: function () {
                      var prevWrapper = wrapper.prev(".circle-reveal-wrapper")
                        .length
                        ? wrapper.prev(".circle-reveal-wrapper")
                        : wrapper;
                      if (
                        prevWrapper.find(".circle-background").hasClass("white")
                      ) {
                        navbar.addClass("dark");
                      } else {
                        navbar.removeClass("dark");
              ...
              currentTransitions[dataId] = {
                ...
                sceneTweenPairs: [
                  {
                    scene: scene,
                    tween: tweenCircleTimeline,
                    isTimeline: true,
                  },
                  { scene: scene2, tween: tweenFadeTimeline, isTimeline: true },
                ],
              };
              ...
              $this
                ...
                .on("click.read-more", function (e) {
                  var index =
                    $(this)
                      .closest(".horizontal-half-wrapper")
                      .index(".horizontal-half-wrapper") + 1;
                  $("html, body").animate(
                    {
                      scrollTop:
                        originalOffset + window.innerHeight * 2 * index,
                    },
                    1200
                  );
                });
              ...
              wrappers.each(function (i) {
                var direction = $(this).hasClass("right-side")
                  ? "right"
                  : "left";
                ...
                if (!$(this).hasClass("active")) {
                  ...
                  tweenDeviceTimeline.to(device, 0.8, activeDeviceObj);
                  tweenDeviceTimeline.to({}, 0.2, {});
                  tweenBackgroundTimeline.set($(this), { zIndex: 1 });
                ...
                tweenDeviceTimeline.to(device, 0.8, {
                  left: "50%",
              ...
              currentTransitions[dataId] = {
                ...
                sceneTweenPairs: [
                  {
                    scene: scene1,
                    tween: tweenDeviceTimeline,
                    isTimeline: true,
                  },
                  {
                    scene: scene2,
                    tween: tweenBackgroundTimeline,
                    isTimeline: true,
                  },
